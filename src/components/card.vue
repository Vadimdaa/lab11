            ...
            <b-card no-body class="mb-1"  v-for="(elements, index) in arr" :key="elements">
              ...
              <b-collapse visible v-bind:id='naming(elements.number)' accordion="my-accordion" role="tabpanel">
                  ...
                  <div class="row mx-auto row-sdf">
                        <b-button v-bind:disabled="namearr == 'backlog'" class="col-8" variant="primary" @click="left(index, elements)">Лево</b-button>
                        ...
                        <b-button v-if = "namearr != 'done'" class="col-8" variant="primary" @click="right(index, elements)">Право</b-button>
                        <b-button v-else class="col-8" variant="primary" @click="del(index, arr)">Удалить</b-button>
                  </div>
                  </b-card-body>
              </b-collapse>
